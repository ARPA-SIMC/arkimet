import unittest
from arkimet.scan.utils.timedef import (
    UNIT_SECOND,
    UNIT_MINUTE,
    UNIT_HOUR,
    UNIT_12HOURS,
...
class TestScanTimerange(unittest.TestCase):
    ...
    def assert_make_same_unit_equals(self, val1, unit1, val2, unit2, eval1, eunit1, eval2, eunit2):
        tr = {
            "step_len": val1,
            "step_unit": unit1,
            "stat_len": val2,
        ...
        self.assertEqual((val1, unit1, val2, unit2), (eval1, eunit1, eval2, eunit2))

    def test_make_same_units(self):
        self.assert_make_same_unit_equals(60, UNIT_MINUTE, 1, UNIT_DAY, 1, UNIT_HOUR, 24, UNIT_HOUR)

        self.assert_make_same_unit_equals(60, UNIT_12HOURS, 1, UNIT_SECOND, 60 * 12 * 3600, UNIT_SECOND, 1, UNIT_SECOND)

        self.assert_make_same_unit_equals(60, UNIT_SECOND, 1, UNIT_SECOND, 60, UNIT_SECOND, 1, UNIT_SECOND)

        self.assert_make_same_unit_equals(60, UNIT_MONTH, 1, UNIT_DECADE, 5, UNIT_YEAR, 10, UNIT_YEAR)

        self.assert_make_same_unit_equals(1, UNIT_NORMAL, 1, UNIT_CENTURY, 3, UNIT_DECADE, 10, UNIT_DECADE)

        with self.assertRaises(ValueError) as e:
            self.assert_make_same_unit_equals(1, UNIT_SECOND, 1, UNIT_MONTH, None, None, None, None)
