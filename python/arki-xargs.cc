...
struct run_ : public MethKwargs<run_, arkipy_ArkiXargs>
{
    ...
    constexpr static const char* signature =
        "command: Sequence[str], inputs: Sequence[str]=None, max_args: "
        "int=None, max_size: str=None, time_interval: str=None, "
        "split_timerange: bool=False";
    ...
    static PyObject* run(Impl* self, PyObject* args, PyObject* kw)
    {
        static const char* kwlist[] = {
            "command",       "inputs",          "max_args", "max_size",
            "time_interval", "split_timerange", nullptr};
        ...
        if (!PyArg_ParseTupleAndKeywords(
                args, kw, "O|OOKz#p", const_cast<char**>(kwlist), &py_command,
                &py_inputs, &py_max_args, &max_size, &time_interval,
                &time_interval_len, &split_timerange))
            return nullptr;
        ...
        try
        {
            ...
            if (time_interval)
                consumer.set_interval(
                    std::string(time_interval, time_interval_len));
            if (split_timerange)
