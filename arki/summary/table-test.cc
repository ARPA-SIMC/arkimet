...
void Tests::register_tests()
{
    ...
    add_method("basic", [] {
        ...
        // Two different tables should compare the same even if they have
        // different intern pointers
        Table table1;
        table1.merge(md);
    ...
    add_method("bigtable", [] {
        ...
        // Compare with itself to access all elements of the table and see if we
        // got garbage
    ...
    //    const types::Type* intern(unsigned pos, std::unique_ptr<types::Type>
    //    item);
    //
    ...
    //
    //    /// Merge a row into the table
    //    void merge(const std::vector<const types::Type*>& md, const Stats&
    //    st);
    //
    //    /// Merge a row into the table, keeping only the items whose mso index
    //    is in \a positions void merge(const std::vector<const types::Type*>&
    //    md, const Stats& st, const std::vector<unsigned>& positions);
    //
    ...
    //    // Due to the internal structure, the same item can be notified more
    //    than once. bool visitItem(size_t msoidx, ItemVisitor& visitor) const;
    //
    //    /**
    //     * Visit all the contents of this node, notifying visitor of all the
    //     full
    //     * nodes found
    //     */
