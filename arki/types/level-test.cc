...
void Tests::register_tests()
{
    ...
    add_generic_test("grib1_ltype", {"GRIB1(0, 0, 0)"},
    ...
    add_generic_test(
        "grib1_l1", {"GRIB1(1)", "GRIB1(100, 132)"},
        {"GRIB1(103, 132)", "GRIB1(103, 132, 0)", "GRIB1(103, 132, 1)"},
        {"GRIB1(103, 133)", "GRIB2S(100, 100, 500)"}, "GRIB1,103,132");

    // Check GRIB1 with a 16 bit l1
    add_generic_test(
        "grib1_l1large", {"GRIB1(1)", "GRIB1(100, 132)"}, "GRIB1(103, 13200)",
        {"GRIB1(103, 13201)", "GRIB2S(100, 100, 500)"}, "GRIB1,103,13200");

    // Check GRIB1 with a layer
    add_generic_test("grib1_l1_l2",
                     {"GRIB1(1)", "GRIB1(100, 132)", "GRIB1(103, 13201)"},
                     "GRIB1(104, 132, 231)",
                     {"GRIB1(104, 133, 231)", "GRIB1(104, 132, 232)",
                      "GRIB2S(100, 100, 500)"},
                     "GRIB1,104,132,231");
    ...
    add_generic_test(
        "grib2s_missing",
        {"GRIB1(1)",
         // FIXME: current implementation sorts missing higher than everything
         // else; it should perhaps be changed at some point
         "GRIB2S(1, -, -)", "GRIB2S(-, 1, -)", "GRIB2S(-, -, 1)",
         "GRIB2S(1, 1, 5)"},
        "GRIB2S(-, -, -)", {}, "GRIB2S,-,-,-");
    ...
    add_method("grib2s_details", [] {
        ...
        o = Level::createGRIB2S(Level::GRIB2_MISSING_TYPE,
                                Level::GRIB2_MISSING_SCALE,
                                Level::GRIB2_MISSING_VALUE);
        wassert(actual(o->style()) == Level::Style::GRIB2S);
        o->get_GRIB2S(ty, sc, va);
    ...
    // Check GRIB2D
    add_generic_test("grib2d", {"GRIB1(1)", "GRIB2S(1, -, -)"},
    ...
    add_generic_test(
        "grib2d_missing",
        {
            ...
            "GRIB1(100, 100)",
            "GRIB2S(1, -, -)",
            // FIXME: current implementation sorts missing higher than
            // everything else; it should perhaps be changed at some point
            "GRIB2D(1, -, -, -, -, -)",
            "GRIB2D(-, 1, -, -, -, -)",
            "GRIB2D(-, -, 1, -, -, -)",
            "GRIB2D(-, -, -, 1, -, -)",
    ...
    add_method("grib2d_details", [] {
        ...
        o = Level::createGRIB2D(
            Level::GRIB2_MISSING_TYPE, Level::GRIB2_MISSING_SCALE,
            Level::GRIB2_MISSING_VALUE, Level::GRIB2_MISSING_TYPE,
            Level::GRIB2_MISSING_SCALE, Level::GRIB2_MISSING_VALUE);
        wassert(actual(o->style()) == Level::Style::GRIB2D);
        o->get_GRIB2D(ty1, sc1, va1, ty2, sc2, va2);
    ...
    add_generic_test("odimh5",
                     {"GRIB1(1)", "GRIB1(100, 100)", "GRIB2S(1, -, -)",
                      "GRIB2S(101, 100, 500, 100, 100, 1000)"},
                     "ODIMH5(10.123, 20.123)",
                     {
                         "ODIMH5(10.124, 20.123)",
                         "ODIMH5(10.123, 20.124)",
                     },
