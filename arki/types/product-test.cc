...
void Tests::register_tests()
{
    ...
    // Check GRIB2
    add_generic_test("grib2", {"GRIB1(1, 2, 3)"}, "GRIB2(1, 2, 3, 4)",
                     {
                         "GRIB2(1, 2, 3, 4, 5)",
                         "GRIB2(2, 3, 4, 5)",
                         "BUFR(1, 2, 3)",
    ...
    add_generic_test("bufr",
                     ...
                     "BUFR(1, 2, 3, name=antani)",
                     {
                         "BUFR(1, 2, 3, name=antani1)",
                         "BUFR(1, 2, 3, name1=antani)",
                     },
                     "BUFR,1,2,3:name=antani");
    ...
    add_generic_test("vm2",
                     ...
                     "VM2,1:bcode=B20013, l1=0, l2=0, lt1=256, lt2=258, p1=0, "
                     "p2=0, tr=254, unit=m");
    ...
    add_method("vm2_derived_lookup", [] {
        skip_unless_vm2();
        using namespace arki::types;
        ValueBag vb1 = ValueBag::parse(
            "bcode=B20013,lt1=256,l1=0,lt2=258,l2=0,tr=254,p1=0,p2=0,unit=m");
        ValueBag vb2 = ValueBag::parse(
            "bcode=NONONO,lt1=256,l1=0,lt2=258,tr=254,p1=0,p2=0,unit=m");
