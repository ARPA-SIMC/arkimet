...
Counter acquire_single_count(
    "Count of dataset acquire operations on single metadata");
Counter acquire_batch_count(
    "Count of dataset acquire operations on metadata batches");
