#ifndef ARKI_DATASET_ONDISK_H
#define ARKI_DATASET_ONDISK_H
 ...
 * \l files with the metadata, associated to the data files, with the extra extension .metadata
 ...
 *
 * When the .appending flagfile is present:
