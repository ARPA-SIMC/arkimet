...
add_method("yearly", [](Fixture& f) {
    ...
    wassert(actual(step->path_in_shard(f.md)) == "2007");
...
add_method("monthly", [](Fixture& f) {
    ...
    wassert(actual(step->path_in_shard(f.md)) == "06");
});
...
add_method("biweekly", [](Fixture& f) {
    ...
    wassert(actual(step->path_in_shard(f.md)) == "06-1");
});
...
add_method("daily", [](Fixture& f) {
    ...
    wassert(actual(step->path_in_shard(f.md)) == "06-05");
});
