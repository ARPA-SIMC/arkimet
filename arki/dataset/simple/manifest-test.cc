...
void fill1(manifest::Writer& writer)
{
    writer.set(
        "2007/07-08.grib", 100,
        core::Interval(core::Time(2007, 7, 8, 0), core::Time(2007, 7, 8, 18)));
    writer.set(
        "2007/07-07.grib", 100,
        core::Interval(core::Time(2007, 7, 7, 6), core::Time(2007, 7, 7, 18)));
    writer.set("2007/10-09.grib", 100,
               core::Interval(core::Time(2007, 10, 9, 0),
                              core::Time(2007, 10, 9, 20)));
}
...
void create_sqlite(const std::vector<manifest::SegmentInfo>& contents)
{
    ...
    m_insert.compile("INSERT OR REPLACE INTO files (file, mtime, start_time, "
                     "end_time) VALUES (?, ?, ?, ?)");
...
void Tests::register_tests()
{
    ...
    add_method("empty_writer", [] {
        core::Interval interval1(core::Time(2024, 1, 1),
                                 core::Time(2024, 7, 1));
    ...
    add_method("segment", [] {
        ...
        wassert(actual(s->time) == core::Interval(core::Time(2007, 7, 7, 6),
                                                  core::Time(2007, 7, 7, 18)));
    });
    ...
    add_method("set_mtime", [] {
        ...
        auto e = wassert_throws(std::runtime_error,
                                writer.set_mtime("missing.grib", 1234));
