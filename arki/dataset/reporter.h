...
{
public:
    void operation_progress(const std::string&, const std::string&, const std::string&) override {}
    void operation_manual_intervention(const std::string&, const std::string&, const std::string&) override {}
    void operation_aborted(const std::string&, const std::string&, const std::string&) override {}
    void operation_report(const std::string&, const std::string&, const std::string&) override {}
    void segment_info(const std::string&, const std::filesystem::path&, const std::string&) override {}
    void segment_repack(const std::string&, const std::filesystem::path&, const std::string&) override {}
    void segment_archive(const std::string&, const std::filesystem::path&, const std::string&) override {}
    void segment_remove(const std::string&, const std::filesystem::path&, const std::string&) override {}
    void segment_deindex(const std::string&, const std::filesystem::path&, const std::string&) override {}
    void segment_rescan(const std::string&, const std::filesystem::path&, const std::string&) override {}
    void segment_tar(const std::string&, const std::filesystem::path&, const std::string&) override {}
    void segment_compress(const std::string&, const std::filesystem::path&, const std::string&) override {}
    void segment_issue51(const std::string&, const std::filesystem::path&, const std::string&) override {}
    void segment_manual_intervention(const std::string&, const std::filesystem::path&, const std::string&) override {}
};
