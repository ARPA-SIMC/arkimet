...
struct Index
{
     ...
     */
    virtual bool query_data(const dataset::DataQuery& q, SegmentManager& segs, metadata_dest_func) = 0;
     ...
     */
    virtual void query_segment(const std::string& relpath, SegmentManager& segs, metadata_dest_func) const = 0;
