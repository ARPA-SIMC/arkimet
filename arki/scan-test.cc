...
add_method("format_from_filename", [] {
    ...
    wassert(actual(scan::Scanner::format_from_filename("test.nc")) == "netcdf");
    wassert(actual(scan::Scanner::format_from_filename("test.netcdf")) == "netcdf");
    wassert(actual(scan::Scanner::format_from_filename("test.nc.gz")) == "netcdf");
    wassert(actual(scan::Scanner::format_from_filename("test.netcdf.gz")) == "netcdf");
    wassert(actual(scan::Scanner::format_from_filename("test.nc.zip")) == "netcdf");
    wassert(actual(scan::Scanner::format_from_filename("test.netcdf.zip")) == "netcdf");
    wassert(actual(scan::Scanner::format_from_filename("test.nc.tar")) == "netcdf");
    wassert(actual(scan::Scanner::format_from_filename("test.netcdf.tar")) == "netcdf");
