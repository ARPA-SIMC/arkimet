...
template <typename Data> class Reader : public data::BaseReader<Data>
{
public:
    core::File fd;
...
template <typename Data> class Checker : public data::BaseChecker<Data>
{
protected:
...
struct Data : public gz::Data
{
    ...
    make_checker(const std::string& format,
