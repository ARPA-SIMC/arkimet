...
public:
    ...
    const scan::Checker& checker() const
    {
        return *std::static_pointer_cast<const scan::Checker>(m_checker);
    }
    scan::Checker& checker()
    {
        return *std::static_pointer_cast<scan::Checker>(m_checker);
    }
