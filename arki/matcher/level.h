...
struct MatchLevelGRIB2S : public MatchLevel
{
    ...
    MatchLevelGRIB2S(const Optional<uint8_t>& type,
...
struct MatchLevelGRIB2D : public MatchLevel
{
    ...
    MatchLevelGRIB2D(const Optional<uint8_t>& type1,
...
struct MatchLevelODIMH5 : public MatchLevel
{
    ...
    MatchLevelODIMH5(const std::vector<double>& vals, double vals_offset,
