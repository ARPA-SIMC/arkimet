...
add_method("grib2s", [] {
    Metadata md;
    arki::tests::fill(md);
    md.set(Level::createGRIB2S(110, 12, 13));
    ...
    md.set(Level::createGRIB2S(Level::GRIB2_MISSING_TYPE, Level::GRIB2_MISSING_SCALE, Level::GRIB2_MISSING_VALUE));
...
add_method("grib2d", [] {
    Metadata md;
    arki::tests::fill(md);
    md.set(Level::createGRIB2D(110, 12, 13, 114, 15, 16));
	...
	//m = Matcher::parse("level:BUFR,11,12,13");
	//ensure(not m(md));
    md.set(Level::createGRIB2D(Level::GRIB2_MISSING_TYPE, Level::GRIB2_MISSING_SCALE, Level::GRIB2_MISSING_VALUE,
...
add_method("odimh5", [] {
    Metadata md;
    arki::tests::fill(md);
    md.set(Level::createODIMH5(10.123, 20.123));
