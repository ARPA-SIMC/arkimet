...
add_method("grib1", [] {
    ...
    md.set(Timerange::createGRIB1(2, 4, 2, 3));
...
add_method("grib2", [] {
    Metadata md;
    arki::tests::fill(md);
    md.set(Timerange::createGRIB2(1, 2, 3, 4));
...
add_method("timedef", [] {
    ...
    md.set(Timerange::decodeString("Timedef(6h,1,3h)"));
    ...
    md.set(Timerange::decodeString("Timedef(6h)"));
    ensure_matches("timerange:Timedef", md);
    ensure_matches("timerange:Timedef,,", md);
    ensure_matches("timerange:Timedef,6h", md);
    ensure_matches("timerange:Timedef,6h,,", md);
    ...
    md.set(Timerange::decodeString("Timedef(6h,2)"));
    ensure_matches("timerange:Timedef", md);
    ensure_matches("timerange:Timedef,,", md);
    ensure_matches("timerange:Timedef,6h", md);
    ensure_matches("timerange:Timedef,6h,,", md);
...
add_method("bufr", [] {
    Metadata md;
    arki::tests::fill(md);
    md.set(Timerange::createBUFR(2, 1));
...
add_method("regression", [] {
    Metadata md;
    md.set(Timerange::createGRIB1(0, 254, 0, 0));
...
add_method("timedef_grib1", [] {
    Metadata md;
    arki::tests::fill(md);
    md.set(Timerange::createGRIB1(0, 0, 60, 0));
    ...
    md.set(Timerange::createGRIB1(3, 1, 1, 3));
    ensure_matches("timerange:Timedef,+3h", md);
...
add_method("timedef_grib2", [] {
    Metadata md;
    arki::tests::fill(md);
    md.set(Timerange::createGRIB2(3, 1, 1, 3));
...
add_method("timedef_timedef", [] {
    Metadata md;
    arki::tests::fill(md);
    md.set(Timerange::decodeString("Timedef(72h,1,6h)"));
    ...
    md.set(Timerange::decodeString("Timedef(72h)"));
    ensure_matches("timerange:Timedef,+72h", md);
    ensure_matches("timerange:Timedef,+72h,-", md);
    ensure_matches("timerange:Timedef,+72h,-,-", md);
    ensure_matches("timerange:Timedef,+72h,,-", md);
    ...
    md.set(Timerange::decodeString("Timedef(72h,1)"));
    ensure_matches("timerange:Timedef,+72h", md);
    ensure_matches("timerange:Timedef,+72h,1", md);
    ensure_matches("timerange:Timedef,+72h,1,-", md);
    ensure_matches("timerange:Timedef,+72h,,-", md);
    ...
    md.set(Timerange::decodeString("Timedef(72d,1,6h)"));
