...
{
    return std::make_shared<core::lock::FileReadLock>("lockfile", lock::policy_ofd);
}

std::shared_ptr<core::AppendLock> make_append()
{
    return std::make_shared<core::lock::FileAppendLock>("lockfile", lock::policy_ofd);
}

std::shared_ptr<core::CheckLock> make_check()
{
    return std::make_shared<core::lock::FileCheckLock>("lockfile", lock::policy_ofd);
}
