...
{
    return Interval(begin == 0 ? Time() : Time(begin, 1),
                    end == 0 ? Time() : Time(end, 1));
}
...
void Tests::register_tests()
{
    ...
    add_method("compare", [] {
        ...
        wassert(
            actual(Time(1, 2, 3, 4, 5, 6).compare(Time(1, 2, 3, 4, 5, 6))) ==
            0);
        wassert(actual(Time(1, 2, 3, 4, 5, 6).compare(Time(1, 2, 3, 4, 5, 7))) <
                0);
        wassert(actual(Time(1, 2, 3, 4, 5, 6).compare(Time(1, 2, 3, 4, 5, 5))) >
                0);
    });
    ...
    // Test Time::generate
    add_method("generate", [] {
        vector<Time> v = Time::generate(Time(2009, 1, 1, 0, 0, 0),
                                        Time(2009, 2, 1, 0, 0, 0), 3600);
    ...
    add_method("range_overlaps", [] {
        ...
        wassert(actual(Time::range_overlaps(topen.get(), topen.get(),
                                            topen.get(), topen.get()))
                    .istrue());
        wassert(actual(Time::range_overlaps(topen.get(), topen.get(),
                                            t2005.get(), t2010.get()))
                    .istrue());
        wassert(actual(Time::range_overlaps(t2005.get(), t2010.get(),
                                            topen.get(), topen.get()))
                    .istrue());
        wassert(actual(Time::range_overlaps(t2005.get(), topen.get(),
                                            topen.get(), topen.get()))
                    .istrue());
        wassert(actual(Time::range_overlaps(t2005.get(), topen.get(),
                                            t2010.get(), topen.get()))
                    .istrue());
        wassert(actual(Time::range_overlaps(t2010.get(), topen.get(),
                                            t2005.get(), topen.get()))
                    .istrue());
        wassert(actual(Time::range_overlaps(topen.get(), t2005.get(),
                                            topen.get(), t2010.get()))
                    .istrue());
        wassert(actual(Time::range_overlaps(topen.get(), t2010.get(),
                                            topen.get(), t2005.get()))
                    .istrue());
        ...
        wassert(actual(Time::range_overlaps(t2010.get(), topen.get(),
                                            topen.get(), t2010.get()))
                    .isfalse());
        wassert(actual(Time::range_overlaps(t2000.get(), t2005.get(),
                                            t2007.get(), t2010.get()))
                    .isfalse());
        wassert(actual(Time::range_overlaps(t2007.get(), t2010.get(),
                                            t2000.get(), t2005.get()))
                    .isfalse());
        wassert(actual(Time::range_overlaps(t2010.get(), topen.get(),
                                            topen.get(), t2005.get()))
    ...
    add_method("spans_one_whole_month", [] {
        ...
        wassert_true(Interval(Time(2000, 1, 1), Time(2000, 2, 1))
                         .spans_one_whole_month());
        wassert_true(Interval(Time(2000, 1, 1), Time(2000, 2, 15))
                         .spans_one_whole_month());
        wassert_true(Interval(Time(1999, 12, 15), Time(2000, 2, 1))
                         .spans_one_whole_month());
        wassert_true(Interval(Time(1999, 12, 15), Time(2000, 2, 15))
                         .spans_one_whole_month());

        wassert_false(interval(2000, 2000).spans_one_whole_month());

        wassert_false(Interval(Time(2000, 1, 1), Time(2000, 1, 31))
                          .spans_one_whole_month());
        wassert_false(Interval(Time(2000, 1, 1), Time(2000, 1, 31, 23, 59, 59))
                          .spans_one_whole_month());
    });
