...
#define TEST_CODEC(encname, decname, val, encsize)                             \
    do                                                                         \
    {                                                                          \
        vector<uint8_t> enc;                                                   \
        ...
        TEST_CODEC(signed, sint, -0x7fffffff, 4u);
        // g++ generates a comparison between signed and unsigned integer
        // expressions warning here
        // ensure_equals(decodeSInt((const unsigned
        // char*)encodeSInt(-0x80000000, 4).data(), 4), -0x80000000);
...
#undef TEST_CODEC
#define TEST_CODEC(name, val, encsize)                                         \
    do                                                                         \
    {                                                                          \
        vector<uint8_t> enc;                                                   \
        core::BinaryEncoder e(enc);                                            \
    ...
    add_method("varints", []() {
    // Check varints
#define TEST_VARINT(TYPE, val, encsize)                                        \
    do                                                                         \
    {                                                                          \
        TYPE v = (val);                                                        \
        vector<uint8_t> enc;                                                   \
