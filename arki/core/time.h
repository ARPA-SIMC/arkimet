...
public:
     ...
     */
    static Time create_lowerbound(int ye, int mo = -1, int da = -1, int ho = -1,
                                  int mi = -1, int se = -1);
     ...
     */
    static Time create_upperbound(int ye, int mo = -1, int da = -1, int ho = -1,
                                  int mi = -1, int se = -1);
     ...
     * lowest possible value
     */
    void set_lowerbound(int ye, int mo = -1, int da = -1, int ho = -1,
                        int mi = -1, int se = -1);
     ...
     * highest possible value
     */
    void set_upperbound(int ye, int mo = -1, int da = -1, int ho = -1,
                        int mi = -1, int se = -1);
     ...
     *
     * For example (remember that months and days start from 1, so a day of 0
     * means "last day of previous month"):
     *
     ...
     */
    static std::vector<Time> generate(const Time& begin, const Time& end,
                                      int step);
     ...
     */
    static bool range_overlaps(const Time* ts1, const Time* te1,
                               const Time* ts2, const Time* te2);

    /**
     * Return the number of seconds between `begin` (included) and `until`
     * (excluded)
     */
