...
void Tests::register_tests()
{
    ...
    add_method("validator_3", [] {
        ...
        const data::Validator& validator = data::netcdf::validator();
    ...
    // NetCDF 5 does not seem supported on Centos 7 (see
    // https://github.com/ARPA-SIMC/arkimet/issues/243) and we currently do not
    // need to support it.
    //
    ...
    add_method("validator_nonnc", [] {
        ...
        wassert_throws(std::runtime_error,
                       validator.validate_file(in, 0, 44412));
    });
}
