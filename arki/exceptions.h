 ...
 */
[[noreturn]] void throw_file_error(const std::filesystem::path& file,
 ...
 */
[[noreturn]] void throw_consistency_error(const std::string& context,
...
template <typename... Args> [[noreturn]] void throw_runtime_error(Args... args)
{
    std::stringstream buf;
    (buf << ... << args);
